/* PrismJS 1.24.1
https://prismjs.com/download.html#themes=prism-tomorrow&languages=clike+csharp+cil&plugins=line-highlight+line-numbers+match-braces */
	...
	function highlightLines(pre, lines, classes) {
		...
		ranges.forEach(function (currentRange) {
			...
			if (hasLineNumbers && Prism.plugins.lineNumbers) {
				...
				if (startNode) {
					var top = (+startNode.dataset.acc + codePreOffset) + 'px';
					mutateActions.push(function () {
						line.style.top = top;
					});
				}
				...
				if (endNode) {
					var height = ((endNode.dataset.acc - startNode.dataset.acc) + parseFloat(endNode.style.height)) + 'px';
					mutateActions.push(function () {
	...
	function resizeElements(elements) {
		...
		infos.forEach(function (info) {
			...
			info.lineHeights.forEach(function (height, lineNumber) {
				...
				wrapper.children[lineNumber].dataset.acc = acc;
				acc += parseFloat(wrapper.children[lineNumber].style.height);
			});
		});
	}
